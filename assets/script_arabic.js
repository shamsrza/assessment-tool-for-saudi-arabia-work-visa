...
// dropdown arrow icon
    ...
    $("header ul.navigation li a").on('click', function(e){
      e.preventDefault();
    ...
    $('a.english').on('click', function(e){
        ...
        if (window.location.href.indexOf("#") > -1) {
          location.replace(`./index.html#${currentPageId}`);
        }else{
          location.replace("./index.html");
        }

        // if(window.location.href.indexOf("/ksa-skillvisa-selfassessment") > -1){
        //   window.location.href.find("/ksa-skillvisa-selfassessment").remove();
        // }
...
// ----  OCCUPATION -----
    ...
    $("#select1").on("change", function(){
      $(".desc-occupation").css({'display' : 'flex', 'flex-direction':'row-reverse', 'justify-content':'left', 'align-items':'center', 'gap':'8px', 'margin-top':'24px'});
    ...
    $(".back-to-last-step#sector").click(function(e){
      ...
      $(".input-age #age-input").on("input", function(){
        ...
        if(ageValue === ""){
          ...
          // $(".desc-age p").html("Candidate does <b>not qualify</b> for a low skill visa, please exit the application");
          $(".desc-age p").html("للحصول على تأشيرة ذات مهارات منخفضة، يرجى الخروج من الطلب <b>غير مؤهل</b> المرشح");
          ...
          $(".desc-age p").css('display','block');
          // $(".desc-age p").html("Candidate <b>qualifies</b> for a low skill visa, please proceed");
          $(".desc-age p").html(" للحصول على تأشيرة ذات مهارات منخفضة، يرجى المتابعة <b> مؤهل </b>المرشح");
      ...
      $(".input-age .submit-btn-age button").on('click', function(){
        ...
        if(parseInt(id) ===  962301 || parseInt(id) === 962302 || parseInt(id) === 962303 || parseInt(id) === 962401 || parseInt(id) === 962402 || parseInt(id) === 962901 || parseInt(id) === 962902){
          ...
          if($(".input-age #age-input").val() < 18 || $("#age-input").val() > 60){
            // $(".final-title").html("Sorry, candidate does not qualify for a low skill visa").css("margin-bottom","50px");
            $(".final-title").html("عذرًا، المرشح غير مؤهل للحصول على تأشيرة ذات مهارات منخفضة").css("margin-bottom","50px");
          }else {
            // $(".final-title").html("Congratulations, candidate gets a low skill visa!").css("margin-bottom","50px");
            $(".final-title").html("!تهانينا، المرشح يحصل على تأشيرة ذات مهارات منخفضة").css("margin-bottom","50px");
          }
        }
      });
    ...
    $(".input-age .back-to-last-step").click(function(e){
      ...
      $(".input-age-high #age-input").on("input", function(){
        ...
        if(ageValue === ""){
          ...
          $(".desc-age p").css('display','block');
          // $(".desc-age p").html("Candidate does <b>not qualify</b> for a high skill visa, please exit the application");
          $(".desc-age p").html("للحصول على تأشيرة المهارة العالية، يرجى الخروج من الطلب <b>مؤهل</b> المرشح غير");
          $(".desc-age img").attr('src','./assets/images/icons/salary-icon-negative.png').css({'display':'block','border':'1px solid #C53532', 'border-radius': '50% 50%', 'width': '28px', 'height':'28px','padding':'6px'});
          $(".submit-btn-age button").attr('disabled','disabled');
        }else if(ageValue >= 30){
          $(".desc-age p").css('display','block');
          // $(".desc-age p").html("Candidate <b>qualifies</b> for a mid skill visa, please proceed");
          $(".desc-age p").html("للحصول على تأشيرة متوسطة المهارة، يرجى المتابعة <b>مؤهل </b>المرشح");
          $(".desc-age img").attr('src','./assets/images/icons/salary-icon-positive.png').css({'display':'block','border':'none', 'padding': '0'});
          $(".submit-btn-age button").removeAttr('disabled');
        }else{
          $(".desc-age p").css('display','block');
          // $(".desc-age p").html("Candidate <b>qualifies</b> for a high skill visa, please proceed");
          $(".desc-age p").html("للحصول على تأشيرة مهارة عالية، يرجى المتابعة <b>مؤهل </b>المرشح");
          $(".desc-age img").attr('src','./assets/images/icons/salary-icon-positive.png').css({'display':'block','border':'none', 'padding': '0'});
          $(".submit-btn-age button").removeAttr('disabled');
        }
      })
      ...
      $(".input-age-high .submit-btn-age button").on('click', function(){
        ...
        if(ageInputHS.val() >= 30 ){
          ...
          $(".final-title").css('display','block');
          $(".final-cumulative-points").css('display','none');
          // $(".final-title").html("Congratulations, candidate gets a mid skill visa!").css("margin-bottom","50px");
          $(".final-title").html("!تهانينا، المرشح يحصل على تأشيرة المهارة المتوسطة").css("margin-bottom","50px");
          $("#final-page img").attr('src','./assets/images/icons/final-positive.png');
        }else if(ageInputHS.val() < 30){
          $("#final-page").css({"display": "flex", "flex-direction": "column", "justify-content": "center", "align-items": "center"});
          $(".final-title").css('display','block');
          $(".final-cumulative-points").css('display','none');
          // $(".final-title").html("Congratulations, candidate gets a high skill visa!").css("margin-bottom","50px");
          $(".final-title").html("!تهانينا، المرشح يحصل على تأشيرة المهارات العالية").css("margin-bottom","50px");
          $("#final-page img").attr('src','./assets/images/icons/final-positive.png');
        } 
      });
    ...
    // continue btn - svp part
      $(".submit-btn-svp button").on('click', function(){
        ...
        if($('input[name=radioName]:checked', '#svp-form').val() === 'yes'){
            ...
            if($(".selectpicker#select1").val() === "High"){
              if($("#salary-input").val() >= 3500){
                // $(".final-title").html("Sorry, candidate does not qualify for a mid skill visa").css("margin-bottom","50px");
                $(".final-title").html("عذرًا، المرشح غير مؤهل للحصول على تأشيرة متوسطة المهارة").css("margin-bottom","50px");
              }else{
                // $(".final-title").html("Sorry, candidate does not qualify for a low skill visa").css("margin-bottom","50px");
                $(".final-title").html("عذرًا، المرشح غير مؤهل للحصول على تأشيرة ذات مهارات منخفضة").css("margin-bottom","50px");
    ...
    $("#salary-input").on("input", function(){
        $(".desc-salary").css({'display' : 'flex', 'flex-direction':'row-reverse', 'justify-content':'right', 'align-items':'center', 'gap':'8px', 'margin-top':'24px'});
          ...
          if($(".selectpicker#select1").val() === "High"){
            if($(".selectpicker#select4").val() === sectorRanges[i].sector){
              if(salaryValue === ""){
                ...
                // $(".desc-salary p").html("Candidate is eligible for applying <b>high</b> skilled visa and gets <span>50</span> <span>points</span>, please continue with the application");
                $(".desc-salary p").html("نقطة، يرجى الاستمرار في الطلب <span>50</span> المرشح مؤهل للحصول على تأشيرة ذوي المهارات العالية ويحصل على");
                ...
                // $(".desc-salary p").html("Candidate qualifies for a <b>high</b> skill visa and gets <span>25</span> <span>points</span>");
                $(".desc-salary p").html("نقطة <span>25</span> يتأهل المرشح للحصول على تأشيرة المهارة العالية ويحصل على");
                $(".desc-salary p span").css('font-weight','bold');
                $(".desc-salary img").attr('src','./assets/images/icons/salary-icon-positive.png').css({'display':'block','border':'none', 'padding': '0'});
                $(".submit-btn-salary button").removeAttr("disabled");
                $(".cumulative-points#salary").css("visibility","visible");
                ...
                $(".desc-salary p").html("<b>تأشيرة متوسطة المهارة</b> المرشح مؤهل للحصول على");
                $(".desc-salary p span").css('font-weight','bold');
                $(".desc-salary img").attr('src','./assets/images/icons/salary-icon-positive.png').css({'display':'block','border':'none', 'padding': '0'});
                $(".submit-btn-salary button").removeAttr("disabled");
                $(".cumulative-points#salary").css("visibility","hidden");
                ...
                // low skill visa
                // $('.desc-salary p').html("Please continue with <b>low</b> skill visa application<span></span>");
                $('.desc-salary p').html("يرجى الاستمرار في طلب التأشيرة ذات المهارات المنخفضة <span></span>");
            ...
            if(salaryValue === ""){
              ...
              if(parseInt(id) < 411001){
                  // $(".cumulative-points#salary").css('display','none');
                $(".cumulative-points#salary").css("visibility","hidden");
              }
            }else if(salaryValue >= parseInt(sectorRanges[i].max)){
            $(".desc-salary p").css('display','block');
            $(".cumulative-points#salary").css({"display":"flex", "flex-direction":"row", "justify-content":"left", "align-items":"center",'gap':'5px'});
            $(".cumulative-points#salary").css("visibility","visible");
            // $('.desc-salary p').html("Please continue with <b>mid</b> skill visa application<span></span>");
            $('.desc-salary p').html("يرجى الاستمرار في طلب تأشيرة المهارة المتوسطة <span></span>");
            $(".submit-btn-salary button").removeAttr("disabled");
      ...
      $(".submit-btn-salary button").on('click', function(){
        ...
        if($(".selectpicker#select1").val() === "High"){
          ...
          $(".svp-title-high").css('display','flex');
          $(".submit-btn-svp").css('display','block');
    ...
    $("#select2").on("change", function(){
      ...
      $(".desc-education").css({'display' : 'flex', 'flex-direction':'row-reverse', 'justify-content':'flex-start', 'align-items':'center', 'gap':'8px', 'margin-top':'24px'});
      // $(".desc-education:nth-child(2)").html('Candidate gets <span>25</span> <span>points</span> based on education selection'); 
      $(".desc-education:nth-child(2)").html('نقطة بناءً على اختيار التعليم <span>25</span> يحصل المرشح على'); 
      ...
      if(dd1 === "bachelor" || dd1 === "master"){
        ...
        if($(".selectpicker#select1").val() === "High"){
          ...
          if(id.startsWith("14") || id.startsWith("3")){
            $(".school-dd").css('display','none');
            // $(".desc-education p").html('Candidate gets <span>50</span> <span>points</span> based on education selection');
            $(".desc-education p").html('نقطة بناءً على اختيار التعليم <span>50</span> يحصل المرشح على'); 
            $(".cumulative-points#edu span:first").html( ((parseInt(slr)) + 50).toString());

          }else{
            $(".school-dd").css('display','block');
            $(".selectpicker#select3").selectpicker('val', '');
            // $(".desc-education p").html('Candidate gets <span>25</span> <span>points</span> based on education selection'); 
            $(".desc-education p").html('نقطة بناءً على اختيار التعليم <span>25</span> يحصل المرشح على');  
        ...
        if($(".selectpicker#select1").val() === "High"){
          if(dd1 === "doctorate"){
            // $(".desc-education p").html('Candidate gets <span>50</span> <span>points</span>, please continue with the application'); 
            $(".desc-education p").html('نقطة، يرجى الاستمرار في التقديم <span>50</span> يحصل المرشح على'); 
            $(".cumulative-points#edu span:first").html( ((parseInt(slr)) + 50).toString());
          }else{
          ...
          if(id.startsWith("14") || id.startsWith("3")){
            if(dd1 === "diploma"){
              // $(".desc-education p").html('Candidate gets <span>25</span> <span>points</span>, please continue with the application'); 
              $(".desc-education p").html('نقطة، يرجى الاستمرار في التقديم <span>25</span> يحصل المرشح على'); 
              $(".cumulative-points#edu span:first").html( ((parseInt(slr)) + 25).toString());
            }else{
              // $(".desc-education p").html('Candidate gets <span>0</span> <span>points</span>, please continue with the application'); 
              $(".desc-education p").html('نقطة، يرجى الاستمرار في التقديم <span>0</span> يحصل المرشح على'); 
      ...
      if(experienceValue === ""){
        $(".desc-experience p").html("<span>0</span>");
         ...
         $(".submit-btn-experience button").attr("disabled", "disabled");
          ...
          // $(".desc-experience p").html("Candidate gets <span>50</span> <span>points</span>");
          $(".desc-experience p").html("نقطة <span>50</span> يحصل المرشح على");
          ...
          // $(".desc-experience p").html("Candidate gets <span>25</span> <span>points</span>");
          $(".desc-experience p").html("نقطة <span>25</span> يحصل المرشح على");
          $(".desc-experience p span").css('font-weight','bold');
          $(".desc-experience img").attr('src','./assets/images/icons/education-icon-positive.png').css({'display':'block','border':'none', 'padding': '0'});
      } else if(experienceValue  < 3){
          // $(".desc-experience p").html("Candidate gets <span>0</span> <span>points</span>");
          $(".desc-experience p").html("نقطة <span>0</span> يحصل المرشح على");
          $(".desc-experience p span").css('font-weight','bold');
          $(".desc-experience img").attr('src','./assets/images/icons/education-icon-positive.png').css({'display':'block','border':'none', 'padding': '0'});
      }
  ...
  $(".submit-btn-experience button").on('click',function(){
    ...
    if($(".final-cumulative-points span").html() >= 75){
      // $(".final-title").html("Congratulations, candidate gets a high skill visa!");
      $(".final-title").html("!تهانينا، المرشح يحصل على تأشيرة المهارات العالية");
      $("#final-page img").attr('src','./assets/images/icons/final-positive.png');
    }else {
      if($(".selectpicker#select1").val() === "High"){
        ...
        //     $("#final-page img").attr('src','./assets/images/icons/final-positive.png');
        // }else{
        //   $(".final-title").html("Sorry, candidate does not get a high skill visa");
        //   $("#final-page img").attr('src','./assets/images/icons/final-negative.png');
        // }
        if($('input#experience-input').val() < 3 && $('input#experience-months-input').val() <= 11){
          if((id.startsWith("1") || id.startsWith("2")) && !id.startsWith("14")){
            if(educationDropdownVal === "bachelor" || educationDropdownVal === "master" || educationDropdownVal === "doctorate"){
              ...
              var eduLevel = $(".selectpicker#select2").val();
              // $(".final-title").html(`Congratulations, candidate has ${eduLevel} education and gets a mid skill visa!`);
              $(".final-title").html(`!ويحصل على تأشيرة متوسطة المهارة ${eduLevel} المرشح لديه تعليم`);
              $("#final-page img").attr('src','./assets/images/icons/final-positive.png');
            }else{
              // $(".final-title").html("Sorry, candidate does not get any type of visa");
              $(".final-title").html(" عذرًا، لا يحصل المرشح على أي نوع من التأشيرة ");
              $("#final-page img").attr('src','./assets/images/icons/final-negative.png');
            }
          ...
          if(educationDropdownVal === "diploma" || educationDropdownVal === "bachelor" || educationDropdownVal === "master" || educationDropdownVal === "doctorate"){
            ...
            // $(".final-title").html("Sorry, candidate does not get a high skill visa");
            $(".final-title").html("عذرًا، لا يحصل المرشح على تأشيرة المهارة العالية");
            $("#final-page img").attr('src','./assets/images/icons/final-negative.png');
          }
        }
      }else if($(".selectpicker#select1").val() === "Medium"){
  ...
  $("a#no-mid").on('click',function(e){
    ...
    $(".final-title").html("الرجاء الخروج من التطبيق");
  });
